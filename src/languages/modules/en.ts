export default {
  ...
  site: {
    ...
    download: {
      ...
      catalogLoading: "Fetching versions from GitHub release feed…",
      catalogReady: "Loaded {count} versions (Atom / latest)",
      catalogFallback: "GitHub unavailable; using fallback version list",
      stable: "Release",
      beta: "Beta",
      ci: "CI",

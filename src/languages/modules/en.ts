export default {
  ...
  site: {
    ...
    download: {
      ...
      catalogLoading: "Syncing versions from GitHub release pages…",
      catalogReady: "Synced {count} downloadable builds",
      catalogFallback: "Release pages unavailable; using built-in version list",
      stable: "Release",
      beta: "Beta",
      ci: "CI",

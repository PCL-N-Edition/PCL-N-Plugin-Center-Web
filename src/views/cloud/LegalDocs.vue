<template>
  <section class="legal-page">
    ...
    <template v-else-if="documents.find(d => d.key === doc)">
      ...
      <p class="legal-meta">版本 {{ current.version }} · 生效日期 {{ current.effective }} · <a :href="current.file" download>下载 Markdown</a></p>
...
const documents = [
  { key: 'terms', title: 'Nexa Cloud 服务条款', version: '1.0', effective: '2026-09-26', file: '/legal/current/terms.zh-CN.md', summary: '适用于 Nexa 账户、NexaStore 及相关在线服务的总条款，包括账户资格、可接受使用、审核与申诉、付费服务及争议解决。' },
  { key: 'privacy', title: 'Nexa Cloud 隐私政策', version: '1.0', effective: '2026-09-26', file: '/legal/current/privacy.zh-CN.md', summary: '说明我们处理哪些个人信息、处理目的、Cookie、保存期限、第三方服务商以及你依法享有的权利。' },
  { key: 'publisher', title: 'NexaStore 发布者分发协议', version: '1.0', effective: '2026-09-26', file: '/legal/current/publisher.zh-CN.md', summary: '向 NexaStore 上传或维护资源的发布者签订的分发协议，覆盖发布资格、许可证、审核、下架与安全撤销。' },
  { key: 'refunds', title: 'Nexa 退款、试用与订阅政策', version: '1.0', effective: '2026-09-26', file: '/legal/current/refunds.zh-CN.md', summary: '适用于 Nexa 自营付费服务的退款、Lite 免费试用、自动续费、付款失败与套餐降级规则。' }
];

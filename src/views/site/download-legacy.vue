<template>
  <main class="download-page">
    ...
    <section class="download-hero">
      <span class="eyebrow">PCL N 1.x</span>
      <h1>{{ locale === 'zh' ? '下载 PCL N 1.x' : 'Download PCL N 1.x' }}</h1>
      <p>{{ t("site.download.subtitle") }}</p>
      <router-link to="/download" style="display:inline-block;margin-top:20px;color:var(--market-accent)">{{ locale === 'zh' ? '体验 PCL Nexa 2.0.0 Alpha' : 'Try PCL Nexa 2.0.0 Alpha' }} ›</router-link>
    </section>
...
watchEffect(() => {
  applyPageSeo({
    title: locale.value === 'zh' ? '下载 PCL N 1.x' : 'Download PCL N 1.x',
